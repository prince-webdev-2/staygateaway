...
const BookIcon = () => {
  return (
    <svg className="w-4 h-4 text-gray-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
      <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 19v-4a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v4H7a2 2 0 0 0-2 2Zm0 0a2 2 0 0 0 2 2h12M9 3v14m7 0v4" />
    </svg>
  );
};
...
//     navigate function
    ...
    return (
        <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 transition-all duration-500 z-50 ${isScrolled ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3" : "py-4"}`}>
                ...
                <div className="hidden md:flex items-center gap-4">
                        <i class={`fa-solid fa-magnifying-glass text-xl text-white transition-all duration-500 cursor-pointer ${isScrolled ? "invert" : ""}`}></i>
                ...
                <div className="flex items-center gap-3 md:hidden">
                        <div className=''>
                                {user && <UserButton className='cl-userButtonPopoverCard'>
                                <UserButton.MenuItems>
                                                <UserButton.Action label='My Bookings' labelIcon={<BookIcon />} onClick={()=> navigate('/my-bookings')}/>
                                        </UserButton.MenuItems>
                                </UserButton>
                        ...
                        <i class={`fa-solid fa-bars cursor-pointer text-xl text-white ${isScrolled ? "invert" : ""}`} onClick={() => setIsMenuOpen(!isMenuOpen)}></i>
                </div>
